...
public class KafkaConsumerConfig {
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, Message>> kafkaListenerMessageContainerFactory(ConsumerFactory<String, Message> consumerMessageFactory) {
    ...
    public ConsumerFactory<String, Message> consumerMessageFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerMessageConfig());
    }
    ...
    public Map<String, Object> consumerMessageConfig() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
